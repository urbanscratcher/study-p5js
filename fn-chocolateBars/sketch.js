// What I learned here
// Number.toFixed(n) : round a number from n decimal place
// Where possible, objects should avoid modifying global variables
// mousePressed() : click & press (execute multiple times)
// mouseClicked() : only when clicked
...
function ChocolateBar(name, imageFile, weight, price, display) {
  ...
  this.draw = function () {
    ...
    var priceString =
      "£" +
      nf(price.toFixed(2), 0, 2) +
      "p ( £" +
      nf(pricePer100g.toFixed(2), 0, 2) +
      "p per 100 grams)";
