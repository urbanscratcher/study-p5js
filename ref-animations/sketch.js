...
// function draw() {
//   fill(i++ % 89, 0, 0, 127);
//   rect((i % 90) * 9, (i % 91) * 9, (i * i) % 92, (i * i) % 93);
// } // #p5
...
function draw() {
  ...
  for (i = 0; i < s; i++) {
    rotate(2.95);
    rect((i * frameCount) / 30 - 10, i - 10, i, i);
  }
}
...
// function draw() {
//   translate(r, r);
//   line(cos((s += 0.0006)) * 50, sin(s++) * r, cos(s) * r, cos(s++));
// }
...
// }
// function draw() {
//   stroke((w * 0.32) % 255, (w * 0.3) % 255, (w * 0.28) % 255, 50);
//   line((w++ >> s) % s, 0, w++ % s, s);
// }
